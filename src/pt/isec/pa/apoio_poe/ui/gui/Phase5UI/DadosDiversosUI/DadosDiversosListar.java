package pt.isec.pa.apoio_poe.ui.gui.Phase5UI.DadosDiversosUI;
...
public class DadosDiversosListar extends VBox {
    TableView tableView;
    List<DadosDiversos> dd;
    public Button btnVoltar;
    public Label lbEstatisticas;
    public DadosDiversosListar(List<DadosDiversos> dd){
        this.dd=dd;
