package pt.isec.pa.apoio_poe.ui.gui.Phase5UI.DadosPropostasUI;
...
public class DadosPropostaMensagemListar extends BorderPane {
    public Button btn1, btn2;
    Label mensagem;

    public DadosPropostaMensagemListar(){
        btn1 = new Button("PROPOSTAS DISPONIVEIS");
        btn2 = new Button("PROPOSTAS ATRIBUIDAS");
