package pt.isec.pa.apoio_poe.ui.gui.GestaoAlunoUI;
...
public class GestaoAlunoMensagens extends BorderPane {

    Button btn1, btn2;
    Label mensagem;

    public GestaoAlunoMensagens(String text,String button1,String button2){
